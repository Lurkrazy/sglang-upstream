...
# Live on the manager itself (operational code reads the attributes), so both
# readback shapes take them from there rather than from the update log.
        ...
        def background_task():
            ...
            with open(filename, "wb") as f:
                try:
                    ...
                    # The snapshot is a field-by-field copy of the same object,
                    # so whatever refused to pickle is in it too.
            ...
            if data_to_dump:
                ...
                with open(filename, "wb") as f:
                    try:
                        ...
                        # The snapshot is a field-by-field copy of the same
                        # object, so whatever refused to pickle is in it too.
